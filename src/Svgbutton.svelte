...
/* what this does is create a small square that I then rotate behind an svg mask, 
giving the apparence of the line animating */
.path-rotation {
  height: 34px;
  width: 34px;
...
/*.burger-filling {
//  @include transition(all,(var(--animation)/2.5),ease-in-//out);
//}
