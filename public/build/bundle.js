...
var app = (function () {
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(line0, file$3, 25, 8, 709);
    			...
    			add_location(line1, file$3, 26, 8, 842);
    		},
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(circle, file$3, 29, 8, 1012);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(animate, file$3, 18, 0, 348);
    			attr_dev(svg, "viewBox", "0 0 32 32");
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			add_location(svg, file$3, 23, 4, 616);
    			...
    			add_location(button, file$3, 22, 0, 468);
    		},
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(animate, file$1, 128, 12, 4400);
    			...
    			add_location(line_1, file$1, 125, 8, 4187);
    			...
    			add_location(svg, file$1, 124, 4, 4118);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(124:4) {#if winner === 'X' || winner === 'O'}",
    		ctx
    	});
    ...
    // (139:2) {#each row as square, j}
    function create_each_block_1(ctx) {
    	let square;
    	let current;

    	function func() {
    		return /*func*/ ctx[16](/*i*/ ctx[24], /*j*/ ctx[27]);
    	}

    	square = new Square({
    			props: {
    				onClick: func,
    				text: /*squares*/ ctx[2][/*i*/ ctx[24]][/*j*/ ctx[27]] === '-'
    				? ''
    				: /*changeXO*/ ctx[12](/*squares*/ ctx[2][/*i*/ ctx[24]][/*j*/ ctx[27]]),
    				anim: /*i*/ ctx[24] == /*lastMove*/ ctx[3].x && /*j*/ ctx[27] == /*lastMove*/ ctx[3].y && /*visible*/ ctx[7]
    				? true
    				: false,
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*squares*/ 4) square_changes.text = /*squares*/ ctx[2][/*i*/ ctx[24]][/*j*/ ctx[27]] === '-'
    			? ''
    			: /*changeXO*/ ctx[12](/*squares*/ ctx[2][/*i*/ ctx[24]][/*j*/ ctx[27]]);

    			if (dirty & /*lastMove, visible*/ 136) square_changes.anim = /*i*/ ctx[24] == /*lastMove*/ ctx[3].x && /*j*/ ctx[27] == /*lastMove*/ ctx[3].y && /*visible*/ ctx[7]
    			? true
    			: false;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(139:2) {#each row as square, j}",
    		ctx
    	});
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 137, 2, 4937);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(137:4) {#each squares as row, i}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 122, 0, 3943);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
